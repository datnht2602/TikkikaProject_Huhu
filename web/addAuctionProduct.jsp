...
<div class="container">
	...
	<div class="row"
			...
			<div class="col-sm-12">				
				<h2>Them San Pham</h2>
				<form action="AddAuctionProductServlet" method="POST">
					<div class="form-group">
						<label>name</label> 
						<input type="text" name="name" class="form-control" placeholder="Enter UserName" value="">
  ...
  <c:forEach var="dept" items="${category}" >
            <option value="${dept.getId()}">${dept.getName()}</option>
						...
						<input type="number" name="regular_price" class="form-control" placeholder="Enter Price" value="">
                                        </div>
                                        
                                         <div class="form-group">
						<label>Starting Bidding Amount</label> 
						<input type="number" name="start_bid" class="form-control" placeholder="Enter Price" value="">
                                        </div> 
                                        
                               <div class="form-group">
						<label>photo</label> 
						<input type="text" name="image" class="form-control" placeholder="Enter description" value="">
                                        </div> 
