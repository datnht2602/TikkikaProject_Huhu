					...
					<div class="card-body contacts_body">
						...
						<li class="active">
							<div class="d-flex bd-highlight">
								...
								<div class="user_info">
									<span><a href="?toUser=${dto.getuID()}">${dto.getName()}</a></span>
								</div>
							</div>
						</li>
						    </c:forEach>
					...
					<div class="card">
						<div class="card-header msg_head">
							<div class="d-flex bd-highlight">
								...
								<div class="user_info">
									<span>Chat with ${uName.getName()}</span>
							  <input type="hidden" id="toUser" value="${uName.getuID()}" type="text">
								</div>
								
							</div>
						<div class="card-body msg_card_body" style="height:300px; overflow-y: scroll; overflow-x: hidden">
